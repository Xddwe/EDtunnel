...
GitHub Repository for [https://github.com/Xddwe/EDtunnel](https://github.com/Xddwe/EDtunnel)
...
1. Copy `_worker.js` code from [here](https://github.com/Xddwe/EDtunnel/blob/main/_worker.js).

2. Alternatively, you can click the button below to deploy directly.

   [![Deploy to Cloudflare Workers](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/Xddwe/EDtunnel)
